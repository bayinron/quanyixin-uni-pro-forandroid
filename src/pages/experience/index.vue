<template>
    <div class="experience_warp">
        <img class="record_bg" src="@/static/img/tt.png" alt="" />

        <div class="experience">
            <div class="expe_warp">
                <img src="@/static/img/zz.png" alt="" />
            </div>
        ...
        <div v-if="adv_" class="adv">
            <div class="adv_text" style="top: 20%">
                <img class="ggao" src="@/static/img/ddh.png" alt="" />
                <div class="buy_s">
                    <span>- - 用爱心架起桥梁 - -</span>
                    <p>{{ tanchuang.msg }}</p>
                </div>
                <img class="close" src="@/static/img/close.png" @click="handleClose" />
            </div>
        </div>
    </div>
</template>
...
import { getZhanche, postOrder, getuserdetail,getOrderInfo2 } from '@/api/index';
