<template>
      ...
      <view class="group_1 flex-col">
        ...
        <view class="group_4 flex-row justify-between">
          <view class="group_5 flex-col">
            <image mode="widthFix" src="@/static/img/axyzbao.png" alt="" />
          </view>
          <view class="text-wrapper_9 flex-col">
            <text class="text_3">爱心孤儿工程</text>
  ...
  <script>
  import baoImage from '@/static/img/axyzbao.png';  // 导入背景图片
  ...
  overflow: hidden;
  .group_1 {
    background: url(https://lanhu-oss.lanhuapp.com/SketchPngc4122a0a8b65d3c76795f73656a455bf1d4b5951b92ef697e6ffd33f40feca71)
      100% no-repeat;
    ...
    .group_4 {
      ...
      width: 702rpx;
      height: 240rpx;
    //   background: url(https://lanhu-oss.lanhuapp.com/SketchPng20733c51180ff7b2d14a1cd9fedfb39cc7dc9677bd3bc80e98d2999f006e697c)
    //     100% no-repeat;
    background:rgba(233, 231, 231, 0.279);
    border-radius: 10rpx;
      background-size: 100% 100%;
      padding: 30rpx 198rpx 30rpx 30rpx;
      .group_5 {
        border-radius: 10rpx;
        width: 180rpx;
        height: 180rpx;
