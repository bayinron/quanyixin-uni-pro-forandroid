        ...
        <view class="box_5 flex-col">
            <view class="box_8 flex-col">
                ...
                <view class="text-wrapper_8 flex-row">
                    <text class="text_19">{{ getBalance }}</text>
...
const getBalance = computed(() => {
    return datas.value.user.benjin;
    // return globalTool.addString([datas.value.user.benjin, datas.value.user.benjin0, datas.value.user.benjin1]);
});
